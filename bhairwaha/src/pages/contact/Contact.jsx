...
const Contact = ({Pagetitle,Seodata}) => {
  ...
  return (
    <>
              ...
              <div className="row contact-row">
                ...
                <div className="row mt-4 contact-row">
                  ...
                  <div className="col-12 contact-row-iner">
                    ...
                    <div className='contact-phone'><span>+977 71-591617</span>
                      <span>+977 98570 85923</span></div>
                  </div>
                  <div className="col-12 contact-row-iner">
                    ...
                    <span>info@bhairahawagardenresort.com</span>
                  </div>
                  <div className="col-12 contact-row-iner contact-address-col">
                    ...
                    <p>Bhairahawa Garden Resort,Siddharthnagar, Lumbini,Nepal</p></div>
      ...
      <section>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3538.8252141916714!2d83.45113957546022!3d27.5058107762987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39969ba7f8e90315%3A0x51f86c44a49510ed!2sBhairahawa%20Garden%20Resort!5e0!3m2!1sen!2sin!4v1704437921749!5m2!1sen!2sin" width="100%" height="450" style={{border:'0'}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </section>
    </>
  )
}
